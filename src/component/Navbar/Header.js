      ...
      <div className={styles.container}>
        <div className={styles.content}>
          ...
          <nav className={styles.nav}>
            ...
            >
              HOME <span className={styles.redirect_icon}><RightOutlined /></span>
            </a>
            <a 
              href="#" 
              className={styles.navLink}
            >
              ABOUT US <span className={styles.redirect_icon}><RightOutlined /></span>
            </a>
            <a 
              href="#" 
              className={styles.navLink}
            >
              CONTACTS <span className={styles.redirect_icon}><RightOutlined /></span>
            </a>
